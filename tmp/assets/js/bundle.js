...
function mouseHandler(scrollbar) {
    ...
    function calcMomentum(direction, clickPosition) {
        ...
        if (direction === Direction.X) {
            ...
            return Object(lodash_es_clamp__WEBPACK_IMPORTED_MODULE_0__["default"])(clickPosition / totalWidth * size.content.width, 0, limit.x) - offset.x;
        }
        if (direction === Direction.Y) {
            var totalHeight = size.container.height + (yAxis.thumb.realSize - yAxis.thumb.displaySize);
            return Object(lodash_es_clamp__WEBPACK_IMPORTED_MODULE_0__["default"])(clickPosition / totalHeight * size.content.height, 0, limit.y) - offset.y;
        }
        return 0;
    }
...
var tabs=document.querySelector(".cb-tabs");var tabsNav=tabs.querySelectorAll(".cb-tabs-nav");var tabsContent=tabs.querySelectorAll(".cb-tabs-content");tabsNav.forEach(function(e,i){e.addEventListener("click",function(){tabsNav.forEach(function(e){return e.classList.remove("-active");});tabsContent.forEach(function(e){return e.classList.remove("-active");});tabsNav[i].classList.add("-active");tabsContent[i].classList.add("-active");tabs.classList.toggle("-inverse",i!==1);});});// Get demo blocks
var demo=document.querySelectorAll(".cb-demo");// Demo: 1
var demoParticles=demo[0].querySelector(".cb-particles");var particles=new _particles__WEBPACK_IMPORTED_MODULE_3__["default"]({container:demoParticles,itemsSelector:".cb-particles-item"});// Demo: 2
var demoParticles2=demo[1].querySelector(".cb-particles");var particles2=new _particles__WEBPACK_IMPORTED_MODULE_3__["default"]({container:demoParticles2,itemsSelector:".cb-particles-item",timeScale:-1,fadeInDuration:0,fadeOutDuration:0,duration:function duration(){return gsap__WEBPACK_IMPORTED_MODULE_4__["default"].utils.random(3,5);}});// Demo: 3
var demoParticles3=demo[2].querySelector(".cb-particles");var particles3=new _particles__WEBPACK_IMPORTED_MODULE_3__["default"]({container:demoParticles3,itemsSelector:".cb-particles-item"});// Intro animation
var tl=gsap__WEBPACK_IMPORTED_MODULE_4__["default"].timeline({paused:true});var demoHeader=demo[0].querySelector(".cb-demo-header h1");// Header
 ...
 */var Particles=/*#__PURE__*/function(){function Particles(options){var _this=this;this.options=Object.assign({},{container:null,itemsSelector:"[data-particle-item]",observable:true,observableTarget:null,observableRefresh:true,repeats:-1,timeScale:1,initialSeek:1500,fadeInDuration:0.7,fadeInEase:"power1.out",fadeOutDuration:0.7,fadeOutEase:"power1.out",yStart:function yStart(){return _this.container.offsetHeight;},yEnd:function yEnd(v,e){return-e.offsetHeight;},xStart:undefined,xEnd:undefined,ease:"none",duration:function duration(){return gsap__WEBPACK_IMPORTED_MODULE_0__["default"].utils.random(5,10);},offset:function offset(){return gsap__WEBPACK_IMPORTED_MODULE_0__["default"].utils.random(0,20);}},options);this.timeScale=this.options.timeScale;this.init();}/**
     * Init particles.
     */var _proto=Particles.prototype;_proto.init=function init(){this.container=typeof this.options.container==="string"?document.querySelector(this.options.container):this.options.container;this.items=this.container.querySelectorAll(this.options.itemsSelector);this.tl=this.createTimeline();if(this.options.observable){this.observe();}else{this.start();}if(this.options.repeats===-1)this.tl.seek(this.options.initialSeek);this.bind();}/**
     * Bind events.
     */;_proto.bind=function bind(){window.addEventListener('resize',this.refresh.bind(this));}/**
     * Remove events.
     */;_proto.unbind=function unbind(){window.removeEventListener('resize',this.refresh.bind(this));}/**
     * Refresh particles.
     */;_proto.refresh=function refresh(){this.tl.invalidate();}/**
     * Start movement.
     */;_proto.start=function start(){this.tl.play().timeScale(this.timeScale);}/**
     * Pause movement.
     */;_proto.stop=function stop(){this.tl.pause();}/**
     * Start IntersectionObserver to container or `observable`.
     *
     * @param {HTMLElement} [observable] - Optional observable element.
     */;_proto.observe=function observe(observable){var _this2=this;if(observable)this.options.observableTarget=observable;if(this.observer)this.unobserve();this.observer=new IntersectionObserver(function(entries){if(entries[0].isIntersecting){if(_this2.options.observableRefresh)_this2.refresh();_this2.start();}else{_this2.stop();}});this.observer.observe(this.options.observableTarget||this.container);}/**
     * Destroy IntersectionObserver.
     */;_proto.unobserve=function unobserve(){if(this.observer)this.unobserve();this.observer=null;}/**
     * Set movement timescale value.
     *
     * @param {number} [scale=1] - timeScale.
     */;_proto.setTimeScale=function setTimeScale(scale){if(scale===void 0){scale=1;}this.timeScale=scale;this.tl.timeScale(scale);}/**
     * Return current movement direction.
     *
     * @return {boolean} - reversed if true.
     */;_proto.isReversed=function isReversed(){return this.timeScale<0;}/**
     * Reverse direction of movement.
     *
     * @param {boolean} reverse - is reversed.
     * @return {boolean} - is reversed.
     */;_proto.setReversed=function setReversed(reverse){if(reverse!==this.isReversed())this.setTimeScale(this.timeScale*-1);return this.isReversed();}/**
     * Return GSAP timeline of movement
     *
     * @return {gsap.core.Timeline} - GSAP timeline.
     */;_proto.getTimeline=function getTimeline(){return this.tl;}/**
     * Create movement timeline.
     *
     * @return {gsap.core.Timeline} - GSAP timeline.
     */;_proto.createTimeline=function createTimeline(){var mtl=new gsap__WEBPACK_IMPORTED_MODULE_0__["default"].timeline({paused:true});for(var i=0;i<this.items.length;i++){var item=this.items[i];var tl=new gsap__WEBPACK_IMPORTED_MODULE_0__["default"].timeline({repeat:this.options.repeats});var offset=this.options.offset();tl.set(item,{willChange:"transform"});if(this.options.fadeInDuration){tl.fromTo(item,{opacity:0},{opacity:1,ease:this.options.fadeInEase,duration:this.options.fadeInDuration,lazy:false},0);}tl.fromTo(item,{y:this.options.yStart,x:this.options.xStart},{y:this.options.yEnd,x:this.options.xEnd,ease:this.options.ease,duration:this.options.duration},0);if(this.options.fadeOutDuration){tl.to(item,{opacity:0,ease:this.options.fadeOutEase,duration:this.options.fadeOutDuration,lazy:false},"-="+this.options.fadeOutDuration);}mtl.add(tl,offset);}return mtl;}/**
     * Destroy GSAP timeline.
     */;_proto.removeTimeline=function removeTimeline(){if(this.tl)this.tl.kill();}/**
     * Stop and destroy particles.
     */;_proto.destroy=function destroy(){this.stop();this.removeTimeline();this.unbind();this.unobserve();};return Particles;}();
